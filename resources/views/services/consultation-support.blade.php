<x-app-layout>
    ...
    <main id="top" class="container mx-auto px-6 py-12 md:py-20 max-w-5xl">
        ...
        <header class="text-center mb-16 reveal-on-scroll">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900">Layanan Konsultasi & Dukungan Teknis</h1>
            <p class="mt-4 text-lg text-gray-600">Bingung? Butuh saran ahli? Kami siap membantu Anda di setiap langkah.</p>
        </header>
        ...
        <section class="flex flex-col md:flex-row items-center gap-12 reveal-on-scroll">
            ...
            <div class="md:w-1/2">
                <img src="https://images.unsplash.com/photo-1556740758-90de374c12ad?q=80&w=2070&auto=format&fit=crop" alt="Ilustrasi Konsultasi Teknis" class="rounded-lg shadow-lg w-full h-auto object-cover">
            </div>
        </section>
        ...
        <section class="reveal-on-scroll">
            <div class="text-center mb-12">
                ...
                <p class="mt-2 text-gray-600">Dapatkan ketenangan pikiran dengan bantuan para ahli.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 flex items-start gap-4">
                    <div class="text-3xl mt-1">🧑‍🏫</div>
                    <div>
                        <h3 class="font-bold text-lg mb-1">Saran Profesional</h3>
                        <p class="text-sm text-gray-600">Dapatkan rekomendasi ROM, metode root, atau solusi terbaik untuk masalah Anda.</p>
                    </div>
                </div>
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 flex items-start gap-4">
                    <div class="text-3xl mt-1">🧱</div>
                    <div>
                        <h3 class="font-bold text-lg mb-1">Solusi "Unbrick"</h3>
                        <p class="text-sm text-gray-600">Bantuan ahli untuk mencoba memperbaiki perangkat yang mengalami soft-brick atau bootloop.</p>
                    </div>
                </div>
                 <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 flex items-start gap-4">
                    <div class="text-3xl mt-1">🧠</div>
                    <div>
                        <h3 class="font-bold text-lg mb-1">Bimbingan Proyek</h3>
                        <p class="text-sm text-gray-600">Panduan langkah demi langkah jika Anda ingin mencoba melakukan modifikasi sendiri dengan aman.</p>
                    </div>
                </div>
                 <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 flex items-start gap-4">
                    <div class="text-3xl mt-1">🕒</div>
                    <div>
                        <h3 class="font-bold text-lg mb-1">Hemat Waktu & Risiko</h3>
                        <p class="text-sm text-gray-600">Hindari kesalahan fatal dan berjam-jam trial-and-error dengan bertanya pada ahlinya.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-3xl mx-auto space-y-4">
                <div class="faq-item border border-gray-200 rounded-lg">
                    <button class="faq-question w-full text-left font-semibold cursor-pointer p-4 flex justify-between items-center gap-4">
                        <span>Bagaimana cara kerja sesi konsultasi?</span>
                    ...
                    <div class="faq-content">
                        <p class="p-4 pt-0 text-gray-600">Anda dapat menjadwalkan sesi online dengan kami. Jelaskan masalah Anda, dan teknisi kami akan memberikan analisis dan solusi melalui sesi video call langsung.</p>
                    </div>
                </div>
                <div class="faq-item border border-gray-200 rounded-lg">
                    <button class="faq-question w-full text-left font-semibold cursor-pointer p-4 flex justify-between items-center gap-4">
                        <span>Apakah ada jaminan masalah saya akan teratasi?</span>
                        <svg class="w-5 h-5 text-gray-500 transform transition-transform duration-300 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                    </button>
                    <div class="faq-content">
                        <p class="p-4 pt-0 text-gray-600">Kami akan memberikan upaya dan analisis terbaik dari keahlian kami. Sebagian besar masalah umum dapat kami selesaikan atau setidaknya kami berikan jalur solusi yang jelas untuk Anda ikuti.</p>
                    </div>
                </div>
            </div>
        </section>
